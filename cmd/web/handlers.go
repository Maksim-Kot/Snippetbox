...
import (
	...
	"github.com/Maksim-Kot/Snippetbox/internal/models"
	"github.com/Maksim-Kot/Snippetbox/internal/validator"
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	// Generate a new session ID when the authentication state or privilege
	// levels changes for the user (e.g. login and logout operations).
